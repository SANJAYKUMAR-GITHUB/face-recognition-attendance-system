...
UPLOAD_FOLDER = r'C:\Face-Recognition-Attendance-System-master\IMAGE_FILES'
...
def gen():
    IMAGE_FILES = []
    filename = []
    dir_path = r'C:\Face-Recognition-Attendance-System-master\IMAGE_FILES'
    ...
    def takeAttendence(name):
        with open(r'attendence.csv', 'a') as f:
